...
function Fridge() {
    let {fridge}=useParams();
    return (
      <>
        <div className='container py-5'>
<div className='row'>
  <h1 className='fw-bold text-center colc text-uppercase my-5'>Search for your preferred fridge </h1>
  ...
  <div className="carousel-inner fw-bolder " >
    <div className="carousel-item active">
      <img src="https://cdn.thewirecutter.com/wp-content/media/2021/09/refrigerators-2048px-frigidaire-FFTR2021TS-topfreezer.jpg" className="d-block w-100" alt="..." style={{height:'400px'}}/>
      <div className="carousel-caption d-none d-md-block">
      
      </div>
    </div>
    <div className="carousel-item">
      <img src="https://www.lg.com/uk/images/fridge-freezers/md07526643/gallery/D1.jpg" className="d-block w-100" alt="..."  style={{height:'400px'}}/>
      <div className="carousel-caption d-none d-md-block">
    
      </div>
    </div>
    <div className="carousel-item">
      <img src="https://www.lg.com/za/images/fridge-freezers/md06045457/gallery/Gallery_Z_04.jpg" className="d-block w-100" alt="..."  style={{height:'400px'}}/>
      <div className="carousel-caption d-none d-md-block">
      </div>
    </div>
  </div>
  ...
  <form>
                          <div className="col-lg-8 col-md-8 col-8 mx-auto ">
                            <input type="text" className="form-control mx-auto mt-5 mb-2" placeholder="Enter brand of Frdige" required />
                            </div>
                            <div className="col-lg-8 col-md-8 col-md-8 col-8 mx-auto"><input type="text" className="form-control mx-auto mb-2" placeholder="Enter Capacity in litres" required/>
                            </div>
                            ...
                            <div className="col-lg-8 col-md-8 col-md-8 col-8 mx-auto"><input type="text" className="form-control mx-auto mb-2" placeholder="Enter Compressor type" required/>
                            </div>
        ...
        <div className='container py-5'>
        <h3 className='text-lg-start fw-bold py-5'>Fridge</h3>
     <div className='row'>
