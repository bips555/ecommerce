...
function Watches() {
    let {watches}=useParams()
    return (
      <>
        <div className='container py-5'>
<div className='row'>
  <h1 className='fw-bold text-center colc text-uppercase my-5'>Search for your preferred watches </h1>
  ...
  <div className="carousel-inner fw-bolder " >
    <div className="carousel-item active">
      <img src="https://static-01.daraz.com.np/p/c01211a675172d1b002ba4d07189f8fe.jpg" className="d-block w-100" alt="..." style={{height:'400px'}}/>
      <div className="carousel-caption d-none d-md-block">
      
      </div>
    </div>
    <div className="carousel-item">
      <img src="https://static-01.daraz.com.np/p/d36f1f6281f073c2e3d6f995c1c40b19.jpg" className="d-block w-100" alt="..."  style={{height:'400px'}}/>
      <div className="carousel-caption d-none d-md-block">
    
      </div>
    </div>
    <div className="carousel-item">
      <img src="https://static-01.daraz.com.np/p/c7a58d480d6b36beb57991646ebd5c98.jpg" className="d-block w-100" alt="..."  style={{height:'400px'}}/>
      <div className="carousel-caption d-none d-md-block">
      </div>
    </div>
  </div>
  ...
  <form>
                          <div className="col-lg-8 col-md-8 col-8 mx-auto ">
                            <input type="text" className="form-control mx-auto mt-5 mb-2 text-dark" placeholder="Enter brand of watch" required />
                            </div>
                            <div className="col-lg-8 col-md-8 col-md-8 col-8 mx-auto"><input type="text" className="form-control mx-auto mb-2 text-dark" placeholder="Enter price range" required/>
                            </div>
                            <div className="col-lg-8 col-md-8 col-md-8 col-8 mx-auto"><input type="text" className="form-control mx-auto mb-2 text-dark" placeholder="Enter case material " required />
                            </div>
                            <div className="col-lg-8 col-md-8 col-md-8 col-8 mx-auto"><input type="text" className="form-control mx-auto mb-2 text-dark" placeholder="Enter strap material" required/>
                            </div>
        ...
        <div className='container py-5'>
        <h3 className='text-lg-start fw-bold py-5'>Watches</h3>
     <div className='row'>
 ...
 <img src={a.thumbnail} className="card-img-top" alt="..." style={{width: '100%',height:'300px'}}/>
